...
describe('API Client - Profile Endpoints', () => {
  ...
  it('should update a profile', async () => {
    const update: ProfileUpdate = { name: 'updated-name' }
    ...
    const result = await api.updateProfile('507f1f77bcf86cd799439011', update)
  ...
  it('should handle 404 errors', async () => {
    ...
    await expect(api.getProfile('invalid-id')).rejects.toThrow(ApiError)
  })
  ...
  it('should handle network errors', async () => {
    ...
    await expect(api.getProfiles()).rejects.toThrow('Network error')
  })
})